...
public class FIS
{
    ...
    private int countScienceNoCredit;
    private boolean addMathNoCredit;

    public FIS() {
        fisRuleAttribute = new RuleAttribute();
        countScienceNoCredit = 0;
        addMathNoCredit = false;
    }
            ...
            for(int i = 0; i < studentSubjects.length; i++)
            {
                        ...
                        || (Objects.equals(studentSubjects[i], "Physics")))
                {
                    ...
                    if(Objects.equals(studentGrades[i], "D")
                            || Objects.equals(studentGrades[i], "E")
                            || Objects.equals(studentGrades[i], "G"))
                        countScienceNoCredit++; // each time found 1 science subject not credit, increment by 1

                    // if got 2 science subjects is fail, straight away return false
                    if(countScienceNoCredit == 2)
                        return false;
                }
            }
